...
public abstract class CustomOption {
    ...
    public static final BooleanOption FULLSCREEN = new BooleanOption("options.fullscreen", gameOptions -> StandardSettingsUtils.getSettingForCategory(PeepoPractice.CONFIGURING_CATEGORY, "fullscreen", false), (gameOptions, aBoolean) -> StandardSettingsUtils.setSettingForCategory(PeepoPractice.CONFIGURING_CATEGORY, "fullscreen", aBoolean));
}
