...
public class PracticeCategoryUtils {
    ...
    public static final String[] ADVANCEMENTS = {
            "adventure/adventuring_time","adventure/arbalistic","adventure/bullseye","adventure/hero_of_the_village","adventure/honey_block_slide",
            "adventure/kill_a_mob","adventure/kill_all_mobs","adventure/ol_betsy","adventure/root","adventure/shoot_arrow","adventure/sleep_in_bed",
            "adventure/sniper_duel","adventure/summon_iron_golem","adventure/throw_trident","adventure/totem_of_undying","adventure/trade",
            "adventure/two_birds_one_arrow","adventure/very_very_frightening","adventure/voluntary_exile","adventure/whos_the_pillager_now",
            "end/dragon_breath","end/dragon_egg","end/elytra","end/enter_end_gateway","end/find_end_city","end/kill_dragon","end/levitate",
            "end/respawn_dragon","end/root",
            "husbandry/balanced_diet","husbandry/bred_all_animals","husbandry/breed_an_animal","husbandry/complete_catalogue","husbandry/fishy_business",
            "husbandry/obtain_netherite_hoe", "husbandry/plant_seed","husbandry/root","husbandry/safely_harvest_honey","husbandry/silk_touch_nest",
            "husbandry/tactical_fishing","husbandry/tame_an_animal",
            "nether/all_effects","nether/all_potions","nether/brew_potion","nether/charge_respawn_anchor","nether/create_beacon","nether/create_full_beacon",
            "nether/distract_piglin","nether/explore_nether","nether/fast_travel","nether/find_bastion","nether/find_fortress","nether/get_wither_skull",
            "nether/loot_bastion","nether/netherite_armor","nether/obtain_ancient_debris","nether/obtain_blaze_rod","nether/obtain_crying_obsidian",
            "nether/return_to_sender","nether/ride_strider","nether/root","nether/summon_wither","nether/uneasy_alliance","nether/use_lodestone",
            "story/cure_zombie_viillager","story/deflect_arrow","story/enchant_item","story/enter_the_end","story/enter_the_nether","story/follow_ender_eye",
            "story/form_obsidian","story/iron_tools","story/lava_bucket","story/mine_diamond","story/mine_stone","story/obtain_armor","story/root",
            "story/shiny_gear","story/smelt_iron","story/upgrade_tools",
    };
